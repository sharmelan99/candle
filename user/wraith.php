...
<body style=" background: url(asset/logorr.jpg) ;">
  ...
  <div class="imagcon">
    <img src="wra.jpg" alt="">
    <img src="wra1.jpg" alt="">
    <img src="wra2.jpg" alt="">
    <img src="wra3.jpg" alt="">
  </div>
  </div>
  </div>
  </div>
...
<div class="partpart">
  ...
  <div class="product-card">
    ...
    <div class="main-images">
      <img id="blue" class="blue active" src="part3.png" alt="blue">
    </div>
  ...
  <div class="product-card">
    ...
    <div class="main-images">
      <img id="blue" class="blue active" src="part2.png" alt="blue">
    </div>
    <div class="shoe-details">
  ...
  <div class="product-card">
    ...
    <div class="main-images">
      <img id="blue" class="blue active" src="part1.png" alt="blue">
    </div>
    <div class="shoe-details">
