        ...
        <div class="content">
            ...
            <section id="brands">
                <div class="container">
                    ...
                    <div class="img-menu">
                        <div class="brand">
                            <img class="rr" src="images/7.jpg">
                            <div class="button">
                                <a href="user/" class="btn">Rolls Royce</a>
                            </div>
                        </div>
            
                        <div class="brand">
                            <img class="rr" src="images/2.jpg">
                            <div class="button">
                                <a href="#" class="btn">Ferrari</a>
                            </div>
                        </div>
                        <div class="brand">
                            <img class="rr" src="images/3.jpg">
                            <div class="button">
                    ...
                    <div class="img-menu">
                        <div class="brand">
                            <img class="rr" src="images/4.jpg">
                            <div class="button">
                                <a href="#" class="btn">BMW</a>
                            </div>
                        </div>
                        <div class="brand">
                            <img class="rr" src="images/5.jpg">
                            <div class="button">
            ...
            <section id="products">
                <div class="product-container">
                    ...
                    <div class="product-menu">
                        <div class="brand1">
                            <img class="rr" src="images/cart1.jpg">
                            ...
                            <div class="read-more">
                                <a href="user/" class="btn">Read More</a>
                            </div>
                        </div>
            
                        <div class="brand1">
                            <img class="rr" src="images/cart2.jpg">
                        ...
                        <div class="brand1">
                            <img class="rr" src="images/cart3.jpg">
                    ...
                    <div class="product-menu">
                        <div class="brand1">
                            <img class="rr" src="images/cart4.jpeg">
                        ...
                        <div class="brand1">
                            <img class="rr" src="images/cart6.jpg">
                        ...
                        <div class="brand1">
                            <img class="rr" src="images/cart7.jpg">
                ...
                <div class="login-container">
                    ...
                    <div class="product-menu">
                        <div class="login-brand">
                            <img class="login-rr" src="images/admin.jpg">
                            <div class="login-btn">
                        ...
                        <div class="login-brand">
                            <img class="login-rr" src="images/user.jpg">
